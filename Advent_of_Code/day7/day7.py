...
Within the terminal output, lines that begin with $ are commands you executed, very much like some modern computers:
                        ...
                        cd - change directory. This changes which directory is the current directory, but the specific
                        ...
                        ls - list. It prints out all the files and directories immediately contained by the current
                                    directory:
...
def no_space_device_71(s: str) -> int:
    """
...
# print(no_space_device_71('test.txt'))
# print(no_space_device_71('input_day_7.txt'))
...
--- Part Two ---
Now, you're ready to choose a directory to delete. The total disk space available to the filesystem is 70000000. To 
run the update, you need unused space of at least 30000000. You need to find a directory you can delete that will free 
...
def no_space_device_72(s: str) -> int:
    """
        ...
        for line in f:
            ...
            match line.split():
                ...
                case size, _:
                    for path in accumulate(stack, func=lambda a, b: a + "/" + b):
                        sizes[path] += int(size)
    return min(size for size in sizes.values() if size >= sizes["/"] - 40_000_000)


# print(no_space_device_72('test.txt'))
# print(no_space_device_72('input_day_7.txt'))

"""
Your puzzle answer was 1111607. Both parts of this puzzle are complete! They provide two gold stars: **
You are two gold stars closer to collecting enough star fruit. You have completed Day 7!
"""
