...
def calorie_counting_11(s: str) -> int:
    """
...
# print(calorie_counting_11('test.txt'))
# print(calorie_counting_11('input_day_1.txt'))


"""
Your puzzle answer was 73211. The first half of this puzzle is complete! It provides one gold star: *
...
def calorie_counting_12(s: str) -> int:
    """
...
# print(calorie_counting_12('test.txt'))
# print(calorie_counting_12('input_day_1.txt'))

"""
Your puzzle answer was 213958. Both parts of this puzzle are complete! They provide two gold stars: **
You are two gold stars closer to collecting enough star fruit. You have completed Day 1!
"""
